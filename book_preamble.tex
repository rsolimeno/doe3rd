...
\usepackage{calc} % to per­form arith­metic on the ar­gu­ments of the LATEX com­mands \set­counter, \ad­dto­counter, \setlength, and \ad­dtolength
...
\usepackage{upgreek}			% to pro­vide the up­right Greek let­ters from the Euler or Adobe Sym­bol fonts as ad­di­tional\\
								%	math sym­bols (\textbackslash\{\}upal­pha, \textbackslash\{\}up­beta, etc.)
